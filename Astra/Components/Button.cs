...
public static unsafe class Button
{
    ...
    public static bool Selectable(string id, string label, ref bool selected, in ButtonStyle style, bool disabled = false, int remainingWidth = 0, Vector2 size = default)
    {
        ImGuiWindow* window = ImGuiP.GetCurrentWindow();
        if (window->SkipItems == 1) return false;
    ...
    public static bool Selectable(string id, string label, bool selected, in ButtonStyle style, bool disabled = false, int remainingWidth = 0, Vector2 size = default)
    {
        ImGuiWindow* window = ImGuiP.GetCurrentWindow();
        if (window->SkipItems == 1) return false;
